...
public class MainBank extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("choose").equals("Add"))
		{
			...
			out.println("<center><a href='index.html'><input type='button' value='GO HOME'></a><br/><br/></center>");
			int i=0;
			...
			try {
				...
				if(n>0)
				{
					out.println("<center>INSERTED SUCCESSFULLY</center>");
				}
				else
				{
					out.println("<center>FAILURE</center>");
				}
		...
		if(request.getParameter("choose").equals("Display"))
		{
			...
			try {
				...
				if(v==0)
				{
					out.println("<ceter>USER NOT FOUND</center>");
				}
			} catch (Exception e) {
				// TODO Auto-generated catch block
